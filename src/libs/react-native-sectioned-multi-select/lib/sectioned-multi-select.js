      ...
      <View>
        ...
        >
          ...
          />
            ...
            >
              ...
              <View style={{alignItems:'center',position:'absolute',bottom:0,width:StyleVariable.width100}}>
                {!showCancelButton && (
                  <Touchable accessibilityComponentType="button" onPress={this._cancelSelection}>
                    ...
                    >
                      {callIfFunction(cancelIconComponent) || (
                        <Icon size={30} name="done" color='green'/>
                      )}
                    </View>
                  </Touchable>
                )}
        ...
        {chipsPosition === 'top' && this._customChipsRenderer()}
          ...
          >
            ...
            >
                <Text style={{fontWeight:'bold'}}>{this.props.selectText}</Text> 
